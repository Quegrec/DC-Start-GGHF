...
import { Crosshair, Zap, Heart, Shield, Skull, Users } from 'lucide-react';
...
export function QuizModule() {
  ...
  const question = "You're in a 5v5 firefight and your team is down 2 players. What's your instinct?";
  ...
  return (
    <section className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-white/60">Answer a few questions to unlock personalized recommendations</p>
      </div>
