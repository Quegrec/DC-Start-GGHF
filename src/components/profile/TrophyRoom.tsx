        ...
        <div className="mb-6 flex items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            <CollapsibleTrigger
              ...
              aria-label={isOpen ? "Réduire la section trophées" : "Déplier la section trophées"}
            >
              <ChevronDown
                ...
                <div key={trophy.id} className="group relative">
                  <div
                    className={`
                      ...
                      ${
                        isEarned
                          ? `bg-linear-to-br from-white/10 to-white/5 ${getRarityBorder(trophy.rarity)} hover:scale-105`
