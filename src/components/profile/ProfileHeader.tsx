    ...
    <div className="rounded-2xl bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 p-8 backdrop-blur-xl relative overflow-hidden">
      ...
      <div className="flex items-start gap-8">
        ...
        <div className="relative flex-shrink-0">
          <div className="w-32 h-32 rounded-2xl overflow-hidden border-2 border-[#00D1FF]/30 shadow-lg shadow-[#00D1FF]/20">
            <ImageWithFallback
        ...
        <div className="flex-1">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="text-[#00D1FF] font-semibold">{currentXP.toLocaleString()} / {nextLevelXP.toLocaleString()} XP</span>
            </div>
